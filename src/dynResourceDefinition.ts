...
export async function genBootnodeDef( client: KubeClient, nodeSetup: Node): Promise<any> {
  ...
  export async function genPodDef(client: KubeClient, nodeSetup: Node): Promise<any> {

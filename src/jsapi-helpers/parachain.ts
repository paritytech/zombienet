...
export async function paraGetBlockHeight(api: ApiPromise, paraId: number): Promise<number> {
...
export async function paraIsRegistered(api: ApiPromise, paraId: number): Promise<boolean> {

...
function parse_url {
  ...
  case "${gh_api_var}" in
    org )
      output="$(sed -E 's|(https:\/\/github.com\/)([A-Za-z0-9_\-]*)\/([A-Za-z0-9_\-]*)\/tree\/([A-Za-z0-9_\-]*)\/(.*)|\2|g' \
          <<< "${gh_remote_dir}")"
              ;;
    repo )
      output="$(sed -E 's|(https:\/\/github.com\/)([A-Za-z0-9_\-]*)\/([A-Za-z0-9_\-]*)\/tree\/([A-Za-z0-9_\-]*)\/(.*)|\3|g' \
          <<< "${gh_remote_dir}")"
              ;;
    branch )
      output="$(sed -E 's|(https:\/\/github.com\/)([A-Za-z0-9_\-]*)\/([A-Za-z0-9_\-]*)\/tree\/([A-Za-z0-9_\-]*)\/(.*)|\4|g' \
          <<< "${gh_remote_dir}")"
              ;;
    gh_dir )
      output="$(sed -E 's|(https:\/\/github.com\/)([A-Za-z0-9_\-]*)\/([A-Za-z0-9_\-]*)\/tree\/([A-Za-z0-9_\-]*)\/(.*)|\5|g' \
          <<< "${gh_remote_dir}")"
              ;;
    ??* )
